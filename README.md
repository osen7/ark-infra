...
详细使用指南请查看 [docs/quickstart.md](docs/quickstart.md) 和 [docs/INDEX.md](docs/INDEX.md)。
...
# C. eBPF（需要额外能力，不满足可回退到 A）
cd ark-probe-ebpf && cargo build --release
...
- [事件协议](docs/EVENT_PROTOCOL.md) - agent↔hub 协议版本与字段约定
